...
public class PlainSection1 extends MapSection{
    ...
    protected void spawnEntities() {
        ...
        mapEntities.add(new Coin(new EntityCoordinates.Builder(4,9,GameEntity.COIN_ID).build()));
        mapEntities.add(new Coin(new EntityCoordinates.Builder(11,9,GameEntity.COIN_ID).build()));
