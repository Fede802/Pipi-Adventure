...
public class PlainSection2 extends MapSection{
    ...
    protected void spawnEntities() {
        mapEntities.add(new Coin(new EntityCoordinates.Builder(2,12,GameEntity.COIN_ID).build()));
        mapEntities.add(new Coin(new EntityCoordinates.Builder(11,7,GameEntity.COIN_ID).build()));
    }
}